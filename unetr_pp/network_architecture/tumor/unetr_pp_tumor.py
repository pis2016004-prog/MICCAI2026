...
# ============================================================
# TUMOR UNETR++ + bridge + skip gates (matching your tumor sizes)
# ============================================================
class UNETR_PP(SegmentationNetwork):
    """
    Tumor UNETR++ topology + LGAG bridge + disagreement FiLM skip gates.
    Keeps your original tumor geometry:
      - feat_size=(4,4,4)
      - decoder2 upsample_kernel_size=(4,4,4)
      - out_size constants unchanged
    Returns:
      - if return_unc: (logits, unc_dict)
      - else: logits
    """
    def __init__(
        self,
        ...
        # Tumor fixed token->volume shape used in your original
        self.feat_size = (4, 4, 4)
        self.hidden_size = int(hidden_size)

        # encoder backbone (tumor)
        ...
        # decoders (KEEP your tumor geometry)
        ...
        # ============================
        # NOTE: if your tumor encoder channels differ, adjust enc_ch values here.
